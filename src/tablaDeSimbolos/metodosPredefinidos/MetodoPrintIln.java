...
public class MetodoPrintIln extends Metodo{ 
    ...
    public MetodoPrintIln(Token tokenIdMet, boolean esDinamico, Tipo tipoMetodo, Token claseContenedora){
    ...
    public void generarCodigo(){
        ...
        TablaSimbolos.listaInstruccionesMaquina.add("IPRINT"); // Lo consumimos y lo imprimimos
