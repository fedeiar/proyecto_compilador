...
public class MetodoPrintC extends Metodo{ 
    ...
    public MetodoPrintC(Token tokenIdMet, boolean esDinamico, Tipo tipoMetodo, Token claseContenedora){
    ...
    public void generarCodigo(){
        ...
        TablaSimbolos.listaInstruccionesMaquina.add("CPRINT"); // Lo consumimos y lo imprimimos
